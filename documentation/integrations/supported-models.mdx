...
| Model Name | Context Window | Max Output | Tool Calling | Vision | Audio | Caching | Cost Tier |
|------------|----------------|------------|--------------|--------|-------|---------|----------|
| gemini-1.5-pro | Unknown | Unknown | ❌ | ❌ | ❌ | ❌ | Unknown |
| gemini-1.5-pro-latest | Unknown | Unknown | ❌ | ❌ | ❌ | ❌ | Unknown |
...
| gpt-5-chat | 128K tokens | 16K tokens | ❌ | ✅ | ❌ | ✅ | Standard |
...
| Model Name | Context Window | Max Output | Tool Calling | Vision | Audio | Caching | Cost Tier |
|------------|----------------|------------|--------------|--------|-------|---------|----------|
| deepseek-r1-distill-llama-70b | 32K tokens | 8K tokens | ❌ | ❌ | ❌ | ❌ | Standard |
...
| Model Name | Context Window | Max Output | Tool Calling | Vision | Audio | Caching | Cost Tier |
|------------|----------------|------------|--------------|--------|-------|---------|----------|
| deepseek-chat | 131K tokens | 8K tokens | ✅ | ❌ | ❌ | ✅ | Budget |
...
| meta-llama/llama-3.1-8b-instruct | 16K tokens | 16K tokens | ❌ | ❌ | ❌ | ❌ | Budget |
| meta-llama/llama-3.3-70b-instruct | 131K tokens | 120K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
...
| qwen-2.5-72b-instruct | 32K tokens | 8K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
